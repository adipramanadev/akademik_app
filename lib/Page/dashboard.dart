...
Future<int> fetchTotalSiswa() async {
  ...
  try {
    final response = await http.get(
      ...
      // 'https://akademikapp.000webhostapp.com/dashboardapi/countsiswa'),
      headers: {
...
Future<List<JenkelData>> fetchJenkel() async {
  ...
  try {
    final response = await http.get(
      Uri.parse(
          'https://kptkgowa.adipramanacomputer.com/dashboardapi/countjenkel'),
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'Cookie': token,
      },
...
void fetchProfile(void Function(List<ProfileData>) onSuccess,
  ...
  try {
    final response = await http.get(
      Uri.parse('https://kptkgowa.adipramanacomputer.com/account/getaccount'),
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'Cookie': token,
      },
...
Future<List<TahunData>> fetchTahunKel() async {
  ...
  try {
    final response = await http.get(
      Uri.parse(
          'https://kptkgowa.adipramanacomputer.com/dashboardapi/countsiswabyyear'),
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'Cookie': token,
      },
