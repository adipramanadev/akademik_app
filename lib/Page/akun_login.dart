...
class _AkunLoginState extends State<AkunLogin> {
  ...
  //       // Cek jika key 'success' ada dan bernilai true
  ...
  //       }
  //     } else {
  //       // Response bukan 200, tampilkan pesan error
  //       Get.snackbar(
  //         "Login Gagal",
  ...
  //     }
  //   } catch (e) {
  //     // Terjadi exception, tampilkan pesan error
  //     Get.snackbar(
  //       "Login Gagal",
  //       "Terjadi kesalahan: $e",
  //       backgroundColor: Colors.red,
  ...
  //   } finally {
  //     isLoading.value =
  //         false; // Pastikan isLoading false setelah proses selesai
  //   }
  // }
