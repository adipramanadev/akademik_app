...
class _SiswaEditState extends State<SiswaEdit> {
  ...
  Future<List<Map<String, dynamic>>> fetchKota() async {
    ...
    final response = await http.get(
      Uri.parse('https://kptkgowa.adipramanacomputer.com/kotaapi/apilist'),
      headers: {
        'Cookie': token,
      },
    );
  ...
  Future<void> siswaEdit() async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://kptkgowa.adipramanacomputer.com/siswaapi/apiedit/$IdSiswa'),
      body: {
  ...
  Future<void> siswaDelete() async {
    ...
    final url = Uri.parse(
        'https://akademikapp.000webhostapp.com/siswaapi/apidelete/$idSiswa');
